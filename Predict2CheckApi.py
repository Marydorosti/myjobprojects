...
Predict2CheckApi_bp = Blueprint('Predict2CheckApi', __name__)
...
def preprocess_query(json_,CustomerName):
    ...
    my_file = open('D:/Dorosti/100.20python Service/GLOBAL PYTHON SERVICE/CheckModels/'+str(CustomerName)+"2bestFeatures.txt", "r")
...
@Predict2CheckApi_bp.route('/Predict2CheckApi',methods=['POST'])

#@app.route('/predict2',  methods = ['POST', 'GET'])
def Predict2CheckApi():
    ...
    if request.method == 'POST':
        ...
        try:
           ...
           # CustomerName = request.args['CustomerName']
            ...
            #model = onnx.load('C://Users//paya8//Desktop//CheckApi//'+str(CustomerName)+'2model.onnx')
            sess = rt.InferenceSession('D:/Dorosti/100.20python Service/GLOBAL PYTHON SERVICE/CheckModels/'+str(CustomerName)+'2model.onnx')
